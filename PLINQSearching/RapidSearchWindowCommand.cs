...
namespace RapidSearching
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class RapidSearchWindowCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RapidSearchWindowCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private RapidSearchWindowCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static RapidSearchWindowCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new RapidSearchWindowCommand(package);
        }
